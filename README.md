...
настройка forwarding:udo cat /proc/sys/net/ipv4/ip_forward
...
запустила. проверила:
elena@bastion:~$ netstat -tlpn (Not all processes could be identified, non-owned process info will not be shown, you would have to be root to see it all.) Active Internet connections (only servers) Proto Recv-Q Send-Q Local Address Foreign Address State PID/Program name
...
Last login: Wed Dec 30 08:14:53 2020 from 10.130.0.7 elena@innerhost:~$
сертификат:
